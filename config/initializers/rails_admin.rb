# RailsAdmin config file. Generated on April 28, 2013 21:57
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Uni Abroad', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Article', 'Contact', 'Student', 'University']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Article', 'Contact', 'Student', 'University']
  ...
  #     configure :short_descr, :text 
  #     configure :full_descr, :text 
